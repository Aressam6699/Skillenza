...
def sortAnswers(qaPairs, count):
    orderedQaPairs = sorted(qaPairs, key=lambda qaPair: qaPair['prob'], reverse =True)
    
    return orderedQaPairs[0:count]
...
def generateQuestions(text, count):
    ...
    orderedQaPairs = sortAnswers(qaPairs, count)
